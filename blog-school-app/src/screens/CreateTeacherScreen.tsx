...
export default function CreateTeacherScreen({ navigation, route }: any) {
  ...
  const handleCreateTeacher = async () => {
    ...
    try {
      ...
      const errorMessage = error.response?.data?.message || 'Erro ao cadastrar professor';
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Preencha os dados para cadastrar um novo docente
          </Text>
        </View>
